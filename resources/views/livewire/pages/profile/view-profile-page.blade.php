        ...
        <div class="w-full max-w-3xl pb-6">
            <div class="relative flex items-center justify-start px-4 py-4 mb-6 bg-white border rounded-lg border-secondary-300">
                <div class="relative z-10 flex flex-col items-center justify-start w-full">
                    ...
                    <div class="flex flex-col justify-center w-full mt-14 sm:mt-0 md:pt-2">
                        ...
                        <div class="flex justify-center w-full">
                            @can('update', $user)
                            <a href="{{ route('profile.update') }}" class="flex items-center justify-start px-2 py-1 text-xs transition duration-150 ease-in-out border-[1.5px] rounded-md text-primary-700 border-primary-700 sm:text-sm hover:text-primary-700 hover:bg-primary-200 focus:outline-hidden focus:bg-primary-200 focus:text-primary-700">
                                <span class="pr-1">
            ...
            <div id="profile__box" class="w-full overflow-hidden border rounded-md border-secondary-300 tab-container justify-evenly">
                ...
                <div class="p-1 border-t sm:p-2 lg:px-3 lg:py-3 content-container">
                    <div class="grid shrink-0 w-full px-3 py-4 content gap-x-6 gap-y-2 lg:gap-y-4 sm:grid-cols-2">
