    ...
    <div class="md:grid md:grid-cols-7">
        <div class="flex items-center justify-between mb-5 sm:w-64 md:72 col-span-full lg:fixed sm:block">
            <div class="mb-3 text-2xl md:mb-6">
                ...
                <p class="inline-flex text-sm px-4 py-1 rounded-full text-orange-700 bg-orange-200">All fields are required</p>
            </div>
        ...
        <form enctype="multipart/form-data" wire:submit.prevent="save" class="max-w-3xl pb-6 sm:grid-cols-2 col-span-full lg:col-span-5 lg:mt-12">
            ...
            <div class="mb-2 gap-x-6 lg:gap-y-2 sm:grid-cols-2">
                <div>
                    <label for="cover_photo" class="label">Cover photo <x-required-field-star/></label>
            ...
            <div class="grid pt-6 gap-x-6 gap-y-2 lg:gap-y-4 sm:grid-cols-2 field_set" data-link="li-pers">
                ...
                <div class="col-span-full">
                    <label for="bio" class="label">About <x-required-field-star/> <span class="text-xs text-blue-800">(25-255 characters long)</span></label>
            ...
            <div class="grid pt-6 gap-x-6 gap-y-2 lg:gap-y-4 sm:grid-cols-2 field_set" data-link="li-edu">
                ...
                <div class="mb-2 col-span-full">
                    <label for="institute" class="label">Institute of Study <x-required-field-star/></label>
                ...
                <div class="col-span-1 mb-2">
                    <label for="course" class="block mb-2 font-medium">Course of Study<x-required-field-star/></label>
                ...
                <div class="col-span-1">
                    <label for="course_level" class="label">Course Level <x-required-field-star/></label>
            ...
            <div class="grid pt-6 mb-4 group gap-x-6 gap-y-2 lg:gap-y-4 sm:grid-cols-2 field_set" data-link="li-apart">
                ...
                <div class="col-span-1 mb-2">
                    <label for="rooms" class="label">Number of Rooms <x-required-field-star/></label>
                ...
                <div class="col-span-1 mb-2">
                    <label for="min_price" class="label">Minimum Budget <x-required-field-star/></label>
                ...
                <div class="col-span-1">
                    <label for="max_price" class="label">Maximum Budget <x-required-field-star/></label>
                    <div class="relative mt-1 rounded-md shadow-sm">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            <span class="text-gray-500 sm:text-sm">
                                ₦
