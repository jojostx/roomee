<div class="w-11/12 m-auto mt-6 mb-6">
    <div class="md:grid md:grid-cols-7">
        <div class="flex items-center justify-between mb-5 sm:w-64 md:72 col-span-full lg:fixed sm:block">
            ...
            <ul x-data class="flex-col hidden w-full px-2 py-2 my-2 overflow-y-auto font-semibold text-secondary-800 list-none bg-secondary-100 border rounded-md shadow-sm lg:flex">
                ...
                <li class="relative w-full my-1 cursor-pointer">
                    ...
                    <label @click="document.getElementById('educational-information').scrollIntoView()" for="education" class="flex items-center px-2 py-2 border border-transparent rounded-md cursor-pointer hover:bg-secondary-300">
                ...
                <li class="relative w-full my-1 cursor-pointer">
                    ...
                    <label @click="document.getElementById('apartment-information').scrollIntoView()" for="apartment" class="flex items-center px-2 py-2 border border-transparent rounded-md cursor-pointer hover:bg-secondary-300">
