<div>
    ...
    <div class="flex justify-end">
        <button wire:click="closeModal()" class="px-1 py-2 font-semibold hover:text-primary-500 focus:text-primary-600 focus:outline-none">Cancel</button>
    </div>
    @endif
    ...
    <div class="px-4 py-2">
        ...
        <div class="flex justify-end pt-2">
            <button wire:click="closeModal()" class="px-1 py-2 mr-4 font-semibold hover:text-primary-500 focus:text-primary-600 focus:outline-none">Cancel</button>
