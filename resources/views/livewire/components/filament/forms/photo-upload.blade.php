<x-forms::field-wrapper 
    ...
    <div
        ...
        <div @class([
                ...
                'w-32 h-32 aspect-w-1 aspect-h-1 overflow-hidden bg-secondary-200 rounded-lg' => $isAvatar(),
            ...
            <input 
                ...
                type="file" 
                accept=".jpg, .jpeg, .png" />
            <div class="z-10 flex items-center justify-center bg-secondary-700/50">
                ...
                <svg x-cloak x-show="isUploading" role="status" class="text-secondary-200 w-9 h-9 animate-spin fill-primary-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <x-filament::modal x-on:close-modal.window="if($event.detail.id == 'photo-upload-cropper-{{ $getStatePath() }}' ) { resetCropper(); }" id="photo-upload-cropper-{{ $getStatePath() }}" heading="Crop Image" displayClasses="" width="2xl">
            <div class="relative bg-white rounded-lg dark:bg-secondary-700">
