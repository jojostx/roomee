...
<div class="col-span-1 px-4 pt-4 pb-2 bg-white border rounded-md">
    ...
    <div class="py-2 pl-1">
        ...
        <div class="text-lg font-semibold text-gray-700">₦{{ number_format(($user->min_budget + $user->max_budget)/2) }}</div>
        <div>
    ...
    <div class="flex items-center justify-between pt-2 pb-1">
        ...
        <div class="flex justify-end pt-1 sm:pt-0">
            ...
            <button wire:click="unfavorite()" class="inline-flex items-center mr-1.5 px-2 py-1 text-xs xs:text-sm text-blue-100 transition duration-150 ease-in-out bg-blue-600 rounded-md hover:text-blue-100 hover:bg-blue-800 focus:outline-none focus:bg-blue-800 focus:text-blue-100">
                <span class="pr-1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-4 h-4" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button wire:click="updateRequest()" class="inline-flex items-center justify-start px-2 py-1 text-xs text-blue-600 transition duration-150 ease-in-out bg-blue-100 rounded-md xs:text-sm hover:text-blue-700 hover:bg-blue-200 focus:outline-none focus:bg-blue-200 focus:text-blue-700">
                <span class="pr-1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-4 h-4" viewBox="0 0 24 24" stroke="currentColor">
