...
<div class="flex items-center w-full gap-2">
    ...
    @else
    <x-filament-support::button class="inline-flex items-center justify-center w-full px-5" wire:click="favorite()" color="secondary" size="sm" icon="heroicon-s-heart" aria-label="add to favorites" title="add to favorites">
        Favorite
    </x-filament-support::button>
    @endif
