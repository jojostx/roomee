...
@php
    $linkClasses = [
        'inline-flex items-center justify-center gap-0.5 font-medium hover:underline focus:outline-hidden focus:underline filament-link',
        'opacity-70 cursor-not-allowed' => $disabled,
        'text-sm' => $size === 'sm',
        'text-lg' => $size === 'lg',
        'text-primary-600 hover:text-primary-500' => $color === 'primary',
        'text-danger-600 hover:text-danger-500' => $color === 'danger',
        'text-secondary-600 hover:text-secondary-500' => $color === 'secondary',
        ...
        'dark:text-secondary-500 dark:hover:text-secondary-400' => $color === 'secondary' && $darkMode,
