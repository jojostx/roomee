...
@php
    $buttonClasses = array_merge([
        'inline-flex items-center justify-center gap-1 font-medium rounded-lg border transition-colors focus:outline-hidden focus:ring-offset-2 focus:ring-2 focus:ring-inset filament-button',
        ...
        'text-secondary-600 border-secondary-600 hover:bg-secondary-600/20 focus:bg-secondary-700/20 focus:ring-offset-secondary-700' => $color === 'gray',
        'text-secondary-800 border-secondary-300 hover:bg-secondary-50 focus:ring-primary-600 focus:text-primary-600 focus:bg-primary-50 focus:border-primary-600' => $color === 'secondary',
        ...
        'dark:text-secondary-400 dark:border-secondary-400 dark:hover:bg-secondary-400/20 dark:focus:bg-secondary-600/20 dark:focus:ring-offset-secondary-600' => $color === 'gray' && $darkMode,
        'dark:border-secondary-600 dark:hover:border-secondary-500 dark:hover:hover:bg-secondary-500/20 dark:text-secondary-200 dark:focus:text-primary-400 dark:focus:border-primary-400 dark:focus:bg-secondary-800/20' => $color === 'secondary' && $darkMode,
    ] : [
        ...
        'bg-secondary-600 hover:bg-secondary-500 focus:bg-secondary-700 focus:ring-offset-secondary-700' => $color === 'gray',
        'text-secondary-800 bg-white border-secondary-300 hover:bg-secondary-50 focus:ring-primary-600 focus:text-primary-600 focus:bg-primary-50 focus:border-primary-600' => $color === 'secondary',
        'dark:bg-secondary-800 dark:border-secondary-600 dark:hover:border-secondary-500 dark:text-secondary-200 dark:focus:text-primary-400 dark:focus:border-primary-400 dark:focus:bg-secondary-800' => $color === 'secondary' && $darkMode,
    ]);
