    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <x-dropdown align="right" width="64" class="ml-auto mr-2">
                <x-slot name="trigger">
                    <button class="relative text-gray-500 hover:text-gray-600 focus:text-blue-600">
                ...
                <x-slot name="content">
                    <div class="p-4">You have no new notifications</div>
                </x-slot>
            </x-dropdown>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button aria-label="settings dropdown button" title="settings dropdown button" class="flex items-center text-sm font-medium text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-blue-700 focus:border-gray-300">
            ...
            <div class="flex items-center px-4">
                <div class="flex-shrink-0">
                    <div class="w-12 h-12 overflow-hidden rounded-full">
                        ...
                        <img id="avatar_img" src="{{ auth()->user()->avatarPath }}" alt="avatar image" width="100%" height="100%">
                        @else
                        <svg class="w-12 h-12 text-gray-400 fill-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
