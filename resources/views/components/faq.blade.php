        ...
        <div class="border-b border-gray-700 col-span-full md:col-span-4">
            @foreach($questions as $question => $answer)   
                <div>
                    ...
                    <label class="relative flex items-center justify-between px-4 py-4 border border-b-0 border-gray-700 cursor-pointer md:px-6 accordion-label hover:bg-primary-300" for="{{ $question }}">
                        <p>{{ $question }}</p>
