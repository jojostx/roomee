<div class="flex flex-col w-full py-12 text-secondary-800 border-b border-secondary-400 md:justify-between md:flex-row">
    <div class="w-full pr-10 mb-4 text-xl font-semibold md:text-2xl md:w-80 lg:mb-0">
        {{ $term_heading }}
    </div>
    <div class="w-full max-w-3xl md:w-10/12">
