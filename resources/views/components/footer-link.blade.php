...
$classes = ($active ?? false)
            ? 'inline-block items-center py-2 text-sm font-semibold leading-5 text-gray-100 focus:outline-none cursor-pointer focus:text-blue-200 transition duration-150 ease-in-out'
