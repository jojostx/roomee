        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox" class="text-primary-600 rounded shadow-xs border-secondary-300 focus:border-primary-300 focus:ring-3 focus:ring-primary-200/50" name="remember">
