        ...
        <div class="px-4">
            <div class="flex flex-col w-full mx-auto md:w-11/12">
                ...
                <x-term>
                    ...
                    <x-slot name="term_body">
                        ...
                        <p class="my-4 text-indent">
                            You understand that all User Content is the sole responsibility of the person from which such User Content originated. This means that You, and not Roomee, are entirely responsible for all User Content that You upload, post, transmit or otherwise make available via Your Account. Roomee does not control the User Content posted via the Service and, as such, does not guarantee the accuracy, integrity or quality of such User Content.
                        </p>

                        <p>
                            You understand that by using the Service, You may be exposed to User Content that is offensive, indecent or objectionable. Under no circumstances will Roomee be liable in any way for any User Content, including, but not limited to, for any errors or omissions in any Content, or for any loss or damage of any kind incurred as a result of the use of any Content posted, transmitted or otherwise made available via the Service. You acknowledge that Roomee does not pre-screen User Content, but that Roomee and its designees shall have the right (but not the obligation) in their sole discretion to refuse, modify or move any Content that is available via the Service. Without limiting the foregoing, Roomee and its designees shall have the right to remove any User Content that violates the Agreement or is otherwise objectionable. You agree that You must evaluate, and bear all risks associated with, the use of any Content, including any reliance on the accuracy, completeness, or usefulness of such Content. In this regard, You acknowledge that You may not reasonably rely on any Content created by Roomee or submitted to Roomee. You acknowledge and agree that Roomee may preserve User Content and may also disclose User Content if required to do so by law or in the good faith belief that such preservation or disclosure is reasonably necessary to:
                        </p>
                        ...
                        <ul class="px-4 my-4 list-decimal">
                            ...
                            <li>protect the rights, property, or personal safety of Roomee, its users and the public.</li>
                        </ul>
                        <p class="my-4 text-indent">
                        ...
                        <p class="my-4 text-indent">
                            If Roomee discloses User Content to comply with legal process or respond to claims that any User Content violates the rights of third-parties, to the extent permitted by law, regulation or legal process, Roomee agrees to provide You with prompt notice of any such legal or governmental demand and reasonably cooperate with You in any effort to seek a protective order or otherwise to contest such required disclosure.
                        </p>

                        Should User Content be found or reported to be in violation with, but not limited to, the following terms, it will be in Roomee’s sole discretion as to what action should be taken. You agree that You will not:
                        ...
                        <ul class="px-4 my-4 list-disc">
                            ...
                            <li>impersonate any person or entity, including, but not limited to, a Roomee official, Roomee user or falsely state or otherwise misrepresent Your affiliation with a person or entity;</li>
                        ...
                        <p class="my-4 text-indent">
                            If any user is reported to be in violation with the letter or spirit of these terms, Roomee retains the right to terminate such account at any time without further warning.
                        </p>
                ...
                <x-term>
                    ...
                    <x-slot name="term_body">
                        This Agreement shall be governed by and construed under the laws of the Federal Capital Territory, Nigeria, as applied to agreements entered into and to be performed in Nigeria by Nigerian residents. The parties consent to the exclusive jurisdiction and venue of the courts located in and serving the Federal Capital, Abuja, Nigeria.
                    </x-slot>
                </x-term>
                <x-term>
                    <x-slot name="term_heading">
                    ...
                    <x-slot name="term_body">
                        This Agreement embodies the entire understanding and agreement between the parties respecting the subject matter of this Agreement and supersedes any and all prior understandings and agreements between the parties respecting such subject matter. Roomee may change the terms of this Agreement at any time by posting modified terms on its website. This Agreement has been prepared in the English Language and such version shall be controlling in all respects and any non-English version of this Agreement is solely for accommodation purposes. Any and all rights and remedies of Roomee upon Your breach or other default under this Agreement will be deemed cumulative and not exclusive of any other right or remedy conferred by this Agreement or by law or equity on Roomee, and the exercise of any one remedy will not preclude the exercise of any other. The captions and headings appearing in this Agreement are for reference only and will not be considered in construing this Agreement. Notices to You may be made via either email or regular mail. The Service may also provide notices of changes to the Agreement or other matters by displaying notices or links to notices to You generally on the Service.
                        <div class="mt-12">
                            ...
                            <strong>Roomee Products, Inc.</strong> <br>
                            Blk B flat 7, INEC quarters, <br> Area 10 Garki,
                            Abuja, Nigeria <br>
