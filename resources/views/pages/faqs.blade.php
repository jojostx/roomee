<x-landing-layout>
    <x-slot name="banner">
        <div class="flex items-center justify-center text-center bg-primary-100 h-60 md:h-80">
            <p class="mt-10 mb-6 text-3xl font-extrabold text-secondary-700 md:text-4xl lg:text-5xl">Frequently Asked Questions</p>
        </div>
    </x-slot>
    ...
    <!-- Feedback Section -->
    <div class="py-16 bg-secondary-100">
        <div class="flex flex-col items-center w-10/12 mx-auto">
            ...
            <form x-on:submit.prevent="submitForm('http://127.0.0.1:8000/faqs')" x-data="form('feedback_Form')" method="POST" id="feedback_Form" class="flex flex-col items-center justify-center mb-4">
                ...
                <x-button type="Submit" class="flex items-center justify-center font-bold text-secondary-100 bg-secondary-800 rounded-full w-28 hover:text-secondary-100 hover:bg-primary-500">
                    Submit
                </x-button>
            </form>
